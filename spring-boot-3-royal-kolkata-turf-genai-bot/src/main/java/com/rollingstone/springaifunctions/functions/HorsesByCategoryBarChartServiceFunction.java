 ...
 */
public class HorsesByCategoryBarChartServiceFunction implements Function<HorseAnalyticsRequest, String> {

    Logger logger  = LoggerFactory.getLogger("ASInfoCountServiceFunction");
    public static final String HORSES_BY_CATEGORY = "http://localhost:8079/api/analytics/total-races-per-category";

    public HorsesByCategoryBarChartServiceFunction() {

    }

    @Override
    public String apply(HorseAnalyticsRequest horseAnalyticsRequest) {
        logger.info("Inside HorsesByCategoryBarChartServiceFunction");
