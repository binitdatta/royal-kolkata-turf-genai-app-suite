...
export STACK_KEYCLOAK_TOKEN_ENDPOINT=https://kcstk02-auth.cp.manh.cloud/auth/realms/master/protocol/openid-connect/token
export STACK_KEYCLOAK_USERNAME=system
export STACK_KEYCLOAK_PASSWORD=K3ycloak@dmin4fe007c7fd5761ba
export KEYCLOAK_CLIENT_URL=https://kcstk02-auth.cp.manh.cloud/clients
